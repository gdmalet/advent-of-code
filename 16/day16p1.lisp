;;;; Advent of code, day 16 problem 1.
;;;; Answer is 40.
...
(defconstant *ticker-tape*
  '((children . 3)
    ...
    (cars . 2)
    (perfumes . 1))
  "The contents of the ticker tape, listing our search criteria.")
...
(defun find-aunts-without (item-count-pair)
  "Return a list of all the aunts that don't have exactly the count
of the item. This considers only those aunts that have some of the
item recorded."
  (loop
     with item = (car item-count-pair) and count = (cdr item-count-pair)
